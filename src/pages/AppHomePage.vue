...
// modifica
    goToShowPage(slug) {
      this.$router.push({ name: 'show-restaurant', params: { slug } });
    }
// modifica
  ...
  <div class="container p-5">
    <div class="row gap-4 justify-content-center">
      ...
      <div v-for="curRestaurant in restaurantsList" :key="curRestaurant.id"
        class="card col-lg-3 col-md-4 col-sm-5 col-7 p-0" @click="goToShowPage(curRestaurant.slug)"> <!--evento di click sulla card-->
